...
sendMessage("Hassan", welcomeMessage); 
...
function temperatureEvaluation(temp) {
    if (temp > 30) {
...
checkTemperature(35, temperatureEvaluation); 
checkTemperature(22, temperatureEvaluation); 
checkTemperature(10, temperatureEvaluation); 
